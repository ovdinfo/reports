...
BubbleChart = (function() {
  ...
  function BubbleChart(data) {
   ...
   this.circleMargin = 3;
    ...
    this.force = null;
    this.circles = null;
    this.fill_color = d3.scale.ordinal().domain(["активист", "антипутин", "антифа", "выборы", "другое", "ЛГБТ", "националистическая", "политзеки", "Против антимагнитского закона", "социальная", "Стратегия-31", "экология"]).range(["#ecf8ff", "#fea61b", "#e4e4e4", "#fc78ea", "#323232", "#cc91f9", "#98a422", "#e33320", "#20cc1a", "#f8fdb3", "#76f7fb", "#6e72f7"]);
...
// CREATE VISUALIZATION
  BubbleChart.prototype.create_vis = function() {
    ...
    that = this;
    this.circles.enter().append("circle").attr("r", 0).attr("fill-opacity", 0.3).attr("fill", function(d) {
      return _this.fill_color(d.subject);
    }).attr("stroke-width", 1).attr("fill-stroke", rgba(0,0,0,.05)).attr("stroke", function(d) {
...
// SHARE
  ...
  BubbleChart.prototype.display_share= function() {
    ...
    $('#main').append('<div id="share_graphs"><h3>Поделиться инфографикой</h3><p><a class="facebook" target="_blank" href="https://www.facebook.com/sharer.php?u=http%3A%2F%2Freports.ovdinfo.org%2F2012%2Finfographics">Facebook</a><a class="twitter" target="_blank" href="http://twitter.com/intent/tweet?status=%D0%98%D0%BD%D1%84%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%BA%D0%B0%20%7C%20%D0%A7%D0%B5%D0%BB%D0%BE%D0%B2%D0%B5%D0%BA%20%D0%B8%D0%B7%20%D0%B0%D0%B2%D1%82%D0%BE%D0%B7%D0%B0%D0%BA%D0%B0%3A%20%D0%BF%D0%BE%D0%BB%D0%B8%D1%82%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B5%20%D0%B7%D0%B0%D0%B4%D0%B5%D1%80%D0%B6%D0%B0%D0%BD%D0%B8%D1%8F%20%D0%B2%20%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B5%20(http%3A%2F%2Freports.ovdinfo.org%2F2012%2Finfographics)">Twitter</a></p><strong>Получите embed код</strong><br><small>Скопируйте и вставьте этот HTML-код в ваш сайт или блог.</small><div><textarea style="margin: 0px 0px 10px; height: 50px; width: 500px;">&lt;iframe width="1000" height="800" frameBorder="0" src="http://reports.ovdinfo.org/2012/infographics/source/ru?embed"&gt;&lt;/iframe&gt;</textarea></div></div>');
  };
 BubbleChart.prototype.hide_share= function() {
		$('#share_graphs').fadeOut('slow').remove();
		$('#vis').fadeIn('slow');
		$('#data-sizeKey').fadeIn('slow');
	};
...
$(function() {
  ...
  return d3.csv("https://docs.google.com/spreadsheet/pub?key=0Au4PSkYLKeoTdHdRYV9SN3BGOVhJTEZtNnFLaWE4RXc&single=true&gid=0&output=csv", render_vis);
});
