...
function buildTable(data) {
  ...
  $.each(data.feed.entry, function (key, val) {
    var content = '<tr class="data ' + val.gsx$ovdid.$t + ' hider"><td>' + val.gsx$date.$t + '</td><td>' + val.gsx$ovd.$t + '</td><td>' + val.gsx$description.$t + '</td><td>' + val.gsx$ovdvalue.$t + '</td><td><a href="/2013/data/#' + val.gsx$id.$t + '">источник</a></td></tr>';
