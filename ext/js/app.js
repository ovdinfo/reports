...
function buildTable(data) {
	  ...
	  $.each(data.feed.entry, function (key, val) {
      	var content = '<tr class="data ' + val.gsx$ovdid.$t + ' hider"><td>' + val.gsx$date.$t + '</td><td>' + val.gsx$ovd.$t + '</td><td>' + val.gsx$ovdaddress.$t + '</td><td class="last">' + val.gsx$ovdvalue.$t + '</td></tr>';
