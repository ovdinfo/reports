...
function($,tablesorter){
  ...
  function buildTableFormat(data) {
    $.each(data.feed.entry, function (key, val) {
      var content = '<tr><td>' + val.gsx$_cokwr.$t + '</td><td>' + val.gsx$_d5fpr.$t + '</td><td>' + val.gsx$_cre1l.$t + '</td></tr>';
  ...
  function buildTableSubject(data) {
    $.each(data.feed.entry, function (key, val) {
      var content = '<tr><td>' + val.gsx$_cokwr.$t + '</td><td>' + val.gsx$_cpzh4.$t + '</td><td>' + val.gsx$_cre1l.$t + '</td></tr>';
  ...
  function buildTableOrganizer(data) {
    $.each(data.feed.entry, function (key, val) {
      var content = '<tr><td>' + val.gsx$_cokwr.$t + '</td><td>' + val.gsx$_cpzh4.$t + '</td><td>' + val.gsx$_ciyn3.$t + '</td></tr>';
