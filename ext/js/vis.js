...
// DISPLAY BY ORGANIZATORS
  ...
  BubbleChart.prototype.display_by_type = function() {
	...
	for(i=0;i<orgs.length;i++){
		this.vis.append("rect").attr("class", "row_" + i).attr("y",35+15*i).attr("x", 50).attr("width","230").attr("height","15").style('cursor','pointer').style('fill','#F04E23').style('opacity','0').data([i]).on('mouseover', this.mouseOverGroup).on('mouseout', this.mouseOutGroup);
