...
// DISPLAY BY ORGANIZATORS
  ...
  BubbleChart.prototype.display_by_type = function() {
	...
	for(i=0;i<orgs.length;i++){
		this.vis.append("rect").attr("class", "row").attr("y",35+15*i).attr("x", 50).attr("width","230").attr("height","20").style('cursor','pointer').style('fill','blue').data([i]).on('mouseover', this.mouseOverGroup).on('mouseout', this.mouseOutGroup);
