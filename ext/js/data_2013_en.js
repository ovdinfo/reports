...
function buildTable(data) {
  $.each(data.feed.entry, function (key, val) {
    ...
    var content = '<tr class="data ' + val.gsx$id.$t + '"><td><a id="' + val.gsx$id.$t +'"></a>' + val.gsx$date.$t + '</td><td>' + val.gsx$agreementeng.$t + '</td><td>' + val.gsx$eventtypeeng.$t + '</td><td>' + val.gsx$subjecteng.$t + '</td><td>' + val.gsx$organizereng.$t + '</td><td>' + val.gsx$descriptioneng.$t + '</td><td>' + val.gsx$numberofdetentions.$t + '</td><td>' + links + '</td></tr>';
